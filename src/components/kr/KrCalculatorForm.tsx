    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          required
        />
        <p className="mt-1 text-xs text-gray-500">3.3% 원천징수 전 총 수입금액</p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-500">사업 관련 지출 (선택)</p>
      </div>
      ...
      <details className="group">
        ...
        <div className="mt-3 space-y-4 pl-1">
          <div>
            <label htmlFor="nationalPension" className="block text-sm text-gray-600">
              국민연금 (원/년)
            </label>
            <input
              id="nationalPension"
          ...
          <div>
            <label htmlFor="healthInsurance" className="block text-sm text-gray-600">
              건강보험 (원/년)
            </label>
            <input
              id="healthInsurance"
